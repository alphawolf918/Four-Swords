...
public class SwordGlacies extends Item
{
	private final float weaponDamage;
	private final EnumToolMaterial toolMaterial;
	
	public SwordGlacies(int par1, EnumToolMaterial par2EnumToolMaterial)
	{
		super(par1);
		...
		this.setUnlocalizedName("glaciessword");
	...
	public ItemStack onItemRightClick(ItemStack itemstack, World world,
		...
		
		{
			...
			for (int u = 0; u < 8; u++) {
				int newJ = (j + u);
				world.setBlock((i + u), j, k, Block.ice.blockID);
				if (newJ <= 256) {
					world.setBlock((i + u), newJ, k, Block.ice.blockID);
				}
			}
