...
public class SwordEnder extends Item
{
	private final float weaponDamage;
	private final EnumToolMaterial toolMaterial;
	
	public SwordEnder(int par1, EnumToolMaterial par2EnumToolMaterial)
	{
		super(par1);
		...
		this.setUnlocalizedName("endersword");
	 ...
	 */
	void checkBlockAt(int x, int y, int z, World world,
			EntityPlayer entityplayer) {
		if (world.getBlockId(x, y, z) == 0) {
			world.playSoundEffect(x + 5.0D, y + 5.0D, z + 5.0D,
					"mob.endermen.portal", 1.0F,
